...
int main(int argc, char *argv[])
{
  ...
  Kernel *(*kfp)();
  Kernel *(*hor)() = create_horizontal_schar;
  Kernel *(*ver)() = create_vertical_schar;
  Kernel *(*l4)() = create_laplacian_4;
  Kernel *(*l20)() = create_laplacian_20;
  ...
  // image_out = gradient_filter(image, rows, cols);
  image_out = apply_sobel(image, rows, cols, l20, l20);
